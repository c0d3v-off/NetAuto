...
root.title('GUI Packet Analyzer')
tk.Label(root, text='Created By : Mahdi aka C0d3v', font="terminus-18-bold").pack()
tk.Label(root, text="Enter a Subdomain IP Address : ", font="terminus-18-bold").pack()
...
tk.Button(button_frame, text='Start Sniffing', command=start_button, width=15, font='terminus-20-bold').pack(side=tk.LEFT)

tk.Button(button_frame, text='Stop Sniffing', command=stop_button, width=15, font='terminus-20-bold').pack(side=tk.LEFT)
